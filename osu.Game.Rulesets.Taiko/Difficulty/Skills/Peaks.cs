...
namespace osu.Game.Rulesets.Taiko.Difficulty.Skills
{
    ...
    {
        private const double rhythm_skill_multiplier = 0.34 * final_multiplier;
        private const double colour_skill_multiplier = 0.4 * final_multiplier;
        private const double stamina_skill_multiplier = 0.36 * final_multiplier;

        private const double final_multiplier = 0.1;
